...
class Property(models.Model):
    ...
    priority_musability = models.CharField(max_length=100, default="low")
    priority_backlink = models.CharField(max_length=100, default="low")
    last_scraped_coverage = models.DateTimeField(null=True, blank=True)
    last_scraped_musability = models.DateTimeField(null=True, blank=True)
    last_scraped_backlink = models.DateTimeField(null=True, blank=True)
